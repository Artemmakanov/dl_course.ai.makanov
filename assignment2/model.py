...
#         self.loss_reg_1 = None
#         self.grad_reg_1 = None
#         self.loss_reg_2 = None
#         self.grad_reg_2 = None
...
#         self.W1.value = np.zeros((self.n_input, self.hidden_layer_size))
#         self.B1.value = np.zeros((1, self.hidden_layer_size))
        
#         self.W2.value = np.zeros((self.hidden_layer_size, self.n_output))
#         self.B2.value = np.zeros((1, self.n_output))
